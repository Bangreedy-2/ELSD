...
The methodology employed involves a comprehensive domain analysis of current manufacturing toolchains, a Problem-Based Learning (PBL) assessment of user pain points, and a comparative analysis of existing solutions. The obtained results from this initial phase confirm the critical need for an abstraction layer in manufacturing and establish a robust set of functional requirements for the proposed system, laying the groundwork for the subsequent implementation phase.
