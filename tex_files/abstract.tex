...
The work culminates in the promotion of GG-Code from a one-way translation target to a strict \emph{superset} of G-code: existing slicer and CAM files can be opened, edited, and losslessly round-tripped, while new layer- and height-anchored constructs allow targeted modifications --- such as inserting a pause at a chosen layer --- to be expressed declaratively. A hybrid line-oriented compilation strategy keeps this practical even on files of over 140{,}000 lines, and a web-based IDE with a three-dimensional toolpath visualizer makes the resulting programs inspectable.
